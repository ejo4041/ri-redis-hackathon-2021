...
public class AdminController {
    ...
    public AdminControllerResponse addTemplateData(
    ...
    public AdminControllerResponse updateTemplate(
    ...
    public AdminControllerResponse updateTemplateData(
        @PathVariable("id") @NotNull String settingsId,
        @RequestBody @NotNull Map.Entry<String, Object> templateSetting
    ) throws Exception {
    ...
    public AdminControllerResponse deleteTemplateData(
        @PathVariable("id") @NotNull String settingsId,
